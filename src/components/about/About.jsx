...
const About = () => {
    ...
    if (location.hash) {
      ...
      if (element) {
        ...
        const correspondingLink = document.querySelector(
          `.sidebar-link[href="${location.hash}"]`
        );
  ...
  const images = [
    { src: "/coverphotos/1.jpg", caption: "Interview 1" },
    { src: "/coverphotos/001.jpg", caption: "Interview 2" },
    { src: "/coverphotos/002.jpg", caption: "Interview 3" },
    { src: "/coverphotos/003.jpg", caption: "Interview 4" },
    { src: "/coverphotos/005.jpg", caption: "Interview 5" },
    { src: "/coverphotos/006.jpg", caption: "Interview 6" },
    { src: "/coverphotos/007.jpg", caption: "Interview 7" },
    { src: "/coverphotos/097.jpg", caption: "Interview 8" },
    { src: "/coverphotos/101.jpg", caption: "Interview 9" },
    { src: "/coverphotos/102.jpg", caption: "Interview 10" },
    { src: "/coverphotos/103.jpg", caption: "Interview 11" },
    { src: "/coverphotos/104.jpg", caption: "Interview 12" },
    { src: "/coverphotos/105.jpg", caption: "Interview 13" },
    { src: "/coverphotos/106.jpg", caption: "Interview 14" },
    { src: "/coverphotos/110.jpg", caption: "Interview 15" }
  ];
  ...
  return (
    <div class="contentabt">
      <div class="sidebar" id="sidebar">
        ...
        <a href="#year4" class="sidebar-link" onClick={() => setActiveTab("tab9")} >
          Cover Stories
        </a>
      </div>
      ...
      <div class="content-area">
        <div id="tab1" class="tab-content">
          ...
          <p class="tab-content1">
            ...
            <ul className="spacing">
              ...
              <li>
                ...
                அமைப்பைத் தோற்றுவித்து தொடர்ந்து சிறப்புடன் நடத்தி வந்தார்.
              </li>
              <li>இந்த அமைப்பு வெள்ளி விழாக் கண்ட பெருமை கொண்டது.</li>
              <li>
                அத்தோடு{" "}
                <span class="heading1">
                  'பகத்சிங் இளைஞர் மன்றம்', 'இளைஞர் எழுச்சி இயக்கம்'
                </span>{" "}
                ஆகிய அமைப்புக்களைத் தோற்றுவித்து நடத்திவந்தார்.
              </li>
              <li>
                {" "}
                ஒரு கட்டத்தில் இத்தனை அமைப்புக்களையும் ஒன்றிணைத்து
                <span class="heading1">'மக்கள் சிந்தனைப் பேரவை'</span> என்ற
                கட்சி சார்பற்ற பொது நல அமைப்பினை கடந்த இருபது ஆண்டுகளுக்கு
                முன்பு நிறுவினார்.
              </li>
            </ul>
          </p>
          <p class="tab-content1">
            ...
            <ul className="spacing">
              <li>
                <span class="heading1">'மக்கள் சிந்தனைப் பேரவை'</span> - என்ற
                இவர் உருவாக்கிய பொது நல அமைப்பு ஈரோட்டைத் தலைமையிடமாக கொண்டு
                மாநிலந் தழுவிய முறையில் மிகச் சிறப்பாகச் செயல்பட்டு வருகிறது.
              </li>
              <li>
                சமூகவியல் லட்சியங்களை அடிப்படையாகக் கொண்ட இவ்வியக்கம் மாணவர்கள்,
                இளைஞர்கள், ஆசிரியர்கள் மற்றும் பொதுமக்கள் மத்தியில்
          ...
          <p class="tab-content1">
            ...
            <ul className="spacing">
              ...
              அமைப்புகளிலும் முக்கியப் பொறுப்புகள் வகித்துச் செயல்பட்டு
              வருகிறார்.
            </ul>
          </p>
          <p class="tab-content1">
          ...
          <p class="tab-content1">
            <span class="heading">
              <span class="heading1">ஜீவா முழக்கம்</span> மலர் தொகுப்பு:-&nbsp;
            </span>
            <ul className="spacing">
              <li>
                <span class="heading1">'ஜீவா முழக்கம்'</span> - வார இதழின்
                சார்பில் சுதந்திரப் பொன் விழா மலர் ஒன்றினைத் தொகுக்கும் முழுப்
                பொறுப்பும் இவரிடத்தில் ஒப்படைக்கப்பட்டது.
              </li>
              <li>
                இவர் வட மாநிலங்களுக்கெல்லாம் நேரடியாகச் சென்று பல பயனுள்ள புதிய
                விபரங்களைத் திரட்டித் தொகுத்தார்.
              </li>
              <li>
                அம் மலர் தமிழகத்தில் வெளியான விடுதலைப் பொன் விழா மலர்களிலேயே
                மிகச் சிறந்த மலராகப் பெரிதும் பாராட்டப்பட்டது.
              </li>
            </ul>
          </p>
          <p class="tab-content1">
            ...
            <ul className="spacing">
              <li>
                ...
                என்ற இவரது தொகுப்புநூல் பிரசித்தி பெற்றதாகும்.
              </li>{" "}
              <li>
                {" "}
                அத்தோடு
                <span class="heading">'வரலாற்றுப் பாதையில்...'</span> என்ற
                இரண்டு பாகங்களைக் கொண்ட இவர் எழுதிய நூல் 2007ஆம் ஆண்டு வெளியான
                தமிழ் நூல்களிலேயே சிறந்த நூல் என சென்னை இலக்கியச் சிந்தனை
                அமைப்பினரால் தேர்வு செய்யப்பட்டு அந்த ஆண்டிற்கான
        ...
        <div id="tab4" class="tab-content">
          ...
          <p class="tab-content1">
            <ul className="spacing">
              ...
              <li>
                அத்தோடு
                <span class="heading1">'வரலாற்றுப் பாதையில்...'</span> என்ற
                இரண்டு பாகங்களைக் கொண்ட இவர் எழுதிய நூல் 2007ஆம் ஆண்டு வெளியான
                தமிழ் நூல்களிலேயே சிறந்த நூல் என சென்னை இலக்கியச் சிந்தனை
                அமைப்பினரால் தேர்வு செய்யப்பட்டு அந்த ஆண்டிற்கான
          ...
          <p class="tab-content1">
            <ul className="spacing">
              <li>
                ...
                மிகப்பெரிய நூலைத் தொகுத்துள்ளார்.
              </li>
              <li>
                1200 பக்கங்களையும் இரண்டு பாகங்களையும் கொண்ட இந்நூல் 2001 ஆம்
                ஆண்டு வெளியிடப்பட்டது.
              </li>
              <li>
                இந்நூலினைத் தயாரிக்க இவர் ஆறாண்டுகள் முழுக்க முழுக்க
                செலவிட்டதும் இவரே இந்நூலைப் பதிப்பித்ததும்
                குறிப்பிடத்தக்கதாகும்.
              </li>
              <li>
                இந்நூலைத் தொகுக்க நாட்டின் பல பகுதிகளுக்கும் சென்று பல அரிய
                செய்திகளைச் சேகரித்துள்ளார்.
              </li>
              <li>
                இதுவரை வெளிவராத அரிய புகைப்படங்கள் நூற்றுக் கணக்கில்
                திரட்டியுள்ளார்.
              </li>
              <li>இந்நூலின் மூன்றாவது பாகத்தை இப்போது தயாரித்து வருகிறார்.</li>
              <li>
                இந்நூலின் மூன்று பாகங்களும் இந்தியிலும் ஆங்கிலத்திலும் கொண்டு
                வரும் தீவிர முயற்சியில் உள்ளார்.
              </li>
              <li>
                <span class="heading1">
                  'தேசவிடுதலையும் தியாகச்சுடர்களும்', 'வரலாற்றுப் பாதையில்'
                  (இரண்டு பாகங்கள்) ,'அன்பார்ந்த மாணவர்களே', 'கந்தகக்
                  காவியங்கள்', 'மெய்வருத்தக் கூலிதரும', 'தமிழர்க்குப் பெருமை
                  சேர்த்த தமிழர் எஸ். ஆர். நாதன்', 'சுதந்திரச் சுடர்கள்',
                  'த.ஸ்டாலின் குணசேகரன் நேர்காணல்கள் ' ,'விடுதலைக்கு விதை தூவிய
                  விவேகானந்தர்', 'மனிதனுக்கு மரணமில்லை ',
                </span>{" "}
          ...
          <p class="tab-content1">
            <ul className="spacing">
              <li>
                ...
                மாணிக்கம்பாளையத்தில் இவரின் முயற்சியால் மக்கள் சிந்தனைப்
                பேரவையின் சார்பில் சுமார்{" "}
                <span className="heading1"> 4 லட்ச ரூபாய் </span>
                செலவில் புதிதாக நூலகக் கட்டிடம் கட்டியதோடு{" "}
                <span className="heading1"> 6,000 க்கும் </span>மேற்பட்ட நல்ல
                நூல்களையும் அன்பளிப்பாக அந்நூலகத்திற்கு வழங்கியுள்ளார்.
              </li>
              <li>
                இந்நூலகத்தை அரசிற்கு ஒப்படைக்கும் விழாவை மாவட்ட ஆட்சித் தலைவரின்
                தலைமையில் நடத்தி ஒப்படைத்ததோடு தற்போது அதனை பல்லாயிரம் அரிய
                நூல்களடங்கிய அரசு நூலகமாகச் செயல்பட வழிவகைசெய்தார்.
              </li>
              <li>
                <span className="heading1"> 2,000 க்கும் </span> மேற்பட்ட
                உறுப்பினர்களைச் சேர்த்து தற்போது மாவட்டத்தில் செயல்பட்டு வரும்
                சிறந்த நூலகங்களில் ஒன்றாக செயல்பட்டு வருகிறது.
              </li>
              <li>
                மாவட்டத்தின் வேறு பல பகுதிகளிலும் தனியார் நூலகங்களை
                உருவாக்கியுள்ளார்.
              </li>
            </ul>
          </p>
          <p class="tab-content1">
            <ul className="spacing">
              <li>
                ...
                கொள்ளவும் தனியாக பயிற்சி முகாம்கள் பல நடத்தியுள்ளார்.
              </li>
              <li>
                மாணவர்களுக்கு எதிர்காலத்தில்{" "}
          ...
          <p class="tab-content1">
            <ul className="spacing">
              <li>
                அரசுப்பொதுத்தேர்வில் தங்களது மாணவர்களை நூறு சதவிகிதம் தேர்ச்சி
                பெற வைக்கும் ஈரோடு மாவட்டம் முழுக்கப் பணியாற்றும் அரசுப்பள்ளி
                ஆசிரியப் பெருமக்களுக்குப் பாராட்டு விழாவை எழுச்சி மிக்க முறையில்
                ஆண்டுதோறும் ஈரோடு நகரில் கடந்த{" "}
                <span className="heading1"> 20 ஆண்டுகளாக </span> நடத்தி வந்தார்.
              </li>
              <li>
                இவ்விழாவில் நுட்ருகனக்கான ஆசிரியப்பெருமக்கள் பாராட்டுமடல் பெற்று
                உற்சாகமடைந்தனர்.
              </li>
            </ul>
          </p>
          <p class="tab-content1">
            <ul className="spacing">
              <li>
                ...
                <span className="heading1">
                  {" "}
                  'ஈரோடு புத்தகத்திருவிழா'{" "}
                </span>{" "}
                என்ற பெயரில் தேசியத் தரத்துடன் கூடிய மாநில அளவிலான மிகப்பெரும்
                புத்தகக்கண்காட்சியை ஈரோடு நகரில் நடத்திவருகிறார்.
              </li>
              <li>
                ஆண்டுதோறும் ஆகஸ்ட் மாதத்தில் 12 நாட்கள் நடைபெறும்
                இப்புத்தகத்திருவிழாவில் கடந்த ஆண்டு (2018) மட்டும் 12 நாட்களில்
                சுமார் <span className="heading1"> 7 கோடி </span> ரூபாய்க்கும்
                மேல் புத்தகங்கள் விற்பனையாகியுள்ளன.
              </li>
              <li>
                சுமார் <span className="heading1"> 7 லட்சத்திற்கும் </span> மேல்
                மக்கள் இப்புத்தகத்திருவிழாவிற்கு வந்து சென்றுள்ளனர்.
              </li>
              <li>
                இப்புத்தகத் திருவிழா சிறிதளவும் வணிகத்தன்மையற்று நுழைவுக்கட்டணம்
                கூட இல்லாமல் முழுக்க சமூகமுன்னேற்றத்தை அடிப்படையாகக்கொண்டு
                நடத்தப்படுவதாகும்.
              </li>
            </ul>
          </p>
        ...
        <div id="year1" class="tab-content">
          ...
          <div class="event">
            ...
            <p>
              'தலை சிறந்த இளைஞர்' (Outstanding Young Person) என்ற ஜேசீஸ் விருது
              வழங்கப்பட்டது.
            </p>
          </div>
          ...
          <div class="event">
            ...
            <p>
              ஈரோடு தமிழ்ச் சங்கப் பேரவை சார்பில் "சாதனை செம்மல் விருது"
              வழங்கப்பட்டது.
            </p>
          </div>
          ...
          <div class="event">
            ...
            <ul className="spacing">
              ...
              <li>
                ஈரோடு வடக்கு ரோட்டரி சங்கம் 'Vocational Excellence Award in
                recognition of his outstanding achievements as an author in
                Tamil Literature' என்ற விருதினை குறிப்புடன் வழங்கியது.
              </li>
            </ul>
          </div>
        ...
        <div id="year3" class="tab-content">
          ...
          <div class="event">
            ...
            <ul className="spacing">
              ...
              <li>
                ...
                விருது' வழங்கப்பட்டது. நாமக்கல் - நாமக்கல் கவிஞர் சிந்தனைப்
                பேரவையின் சார்பில் 'நாமக்கல் கவிஞர் நற்றமிழ் விருது'
                வழங்கப்பட்டது.
              </li>
              <li>
          ...
          <div class="event">
            ...
            <ul className="spacing">
              ...
              <li>
                இந்திய கனசங்கம் சார்பில் "கெளதம் புத்தர் விருது" வழங்கப்பட்டது
              </li>
            </ul>
          </div>
        </div>
        <div id="year4" className="tab-content">
          {activeTab === "tab9" && (
            <div className="gallery2">
              {images.map((img, idx) => (
                <div className="image-wrapper2">
                  <img src={img.src} alt={img.caption} loading="lazy" className="coverimage" />
